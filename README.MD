...
As subredes foram divididas usando a calculadora com as seguintes configurações:

![Calculo das subredes](Subredes.png)
...
![Tela do PacketTracer mostrando a rede Financeiro](Financeiro.png)
...
![Tela do PacketTracer mostrando a rede RH](RH.png)
• **Rede Tecnologia**:
...
![Tela do PacketTracer mostrando a rede RH](TI.png)
...
![Tela do PacketTracer mostrando a rede Roteadores](Rotoeadores.png)
...
## O Arquivo do Projeto final pode ser encontrado no Repositorio
